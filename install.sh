...
# Instagram: @technifai
# Github: https://github.com/technifai
...
echo -e "\e[032m" "Now, share any Youtube video with Termux and you will be asked to select the quality of your video and after that,It will be automatically Downloaded. If You will share shorts, it will be download automatically."
echo -e "\e[033m" "For More Awesome and Useful Tool like this follow @technifai on Instagram "
